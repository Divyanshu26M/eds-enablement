...
const PAGE_TEMPLATE = {
  name: 'faq',
  description: 'Support page with a hero, an accordion of expandable Q&A rows, a connect section and a CTA banner',
  urls: [
  ...
  blocks: [
    ...
    { name: 'accordion-faq', instances: ['#main-content > section.section:nth-of-type(1) .grid-layout', '#main-content > section.section:nth-of-type(1) .accordion', '#main-content > section.section:nth-of-type(1) > div.container'] },
  ...
  sections: [
    ...
    { id: 'rc3', name: 'connect', selector: ['#main-content > section.section.secondary-section'], style: 'light', blocks: ['columns-contact'], defaultContent: [] },
